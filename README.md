...
## Purpose
Nexus was designed to give developers a starting framework for any project requiring 3D graphics and/or input, audio control, ect, while still providing full transparency and customization. 

Nexus was also designed to be modular, as anything besides Rendering such as Audio, Input, ect is an optional feature that one can simpily choose to not load.
## Features
### Rendering APIs
- Vulkan
- OpenGL
